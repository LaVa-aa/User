...
struct userDetail_Previews: PreviewProvider {
    ...
    static var newUser = Users.UserDetail(name: Users.UserDetail.NameOfUser(title: "Hr", first: "GGGg", last: "Etyui"), location: Users.UserDetail.LocationOfUser(street: Users.UserDetail.LocationOfUser.StreetOfUser(number: 45, name: "Sigridsvej"), postcode: 8220, city: "Brabrand"), dob: Users.UserDetail.DateOfBirthOfUser(date: Date(), age: 25), picture: Users.UserDetail.PicturesOfUser(medium: "", large: "", thumbnail: ""))
